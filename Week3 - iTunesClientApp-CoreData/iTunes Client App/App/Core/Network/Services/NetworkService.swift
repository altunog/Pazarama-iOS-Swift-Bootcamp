...
protocol NetworkService {
    func request<Request: Requestable>(_ request: Request, compilation: @escaping (Result<Request.Response, Error>) -> Void)
}
...
struct BaseNetworkService: NetworkService {
    func request<Request: Requestable>(_ request: Request, compilation: @escaping (Result<Request.Response, Error>) -> Void) {
        ...
        URLSession.shared.dataTask(with: urlRequest) { data, response, error in
            ...
            do {
                try compilation(.success(request.decodeResponse(data)))
